...
<div class="container">
    <div class="row">
        <div class="col-md-offset-5 col-md-3" >
            ...
            <!-- <h4>NOUS VOUS PROPOSONS DE REINITIALISER VOTRE MOT DE PASSE; VEUILLEZ ENTRER CI DESSOUS VOTRE ADRESSE EMAIL AFIN QU'UN LIEN DE REINITIALISATION VOSU SOIT ENVOYE</h4> -->
            <p>Nous vous proposons de réinitialiser votre mot de passe.</p>
            <p>Veuillez entrer ci dessous votre adresse email afin qu'un lien de réinitialisation vous soit envoyé:</p>
			...
			<a href="registration2.php" class="btn btn-info form-control" role="button">Envoyer le lien</a>
			<br>
