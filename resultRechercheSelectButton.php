...
$nomCroisiere = $_POST['nomCroisiere'];
	...
	AND I.idDescription = D.idDescription
	AND I.type='logo'
	AND C.nomCroisiere = '$nomCroisiere'
	";
...
?>
	...
	<div class="col-md-9">
		...
		<!-- 		<div class="col-md-4 ArrangeMarge"  >
			...
			<?php while($croisiere5 = mysqli_fetch_assoc($result5)) : ?>
...
<!-- 	echo <?=$idUser;?>; -->
					...
					<h4><font color="black" size="3" face="Playfair Display"><b><?= $croisiere5['nomCroisiere'];?></b></font></h4>
					
					
						<img src="<?= $croisiere5['lien']; ?>"  alt="Asie du Sud Est" class="img-thumb">
			
					
					<p><font color="#778899" size="3" face="Playfair Display"><?= $croisiere5['resume']; ?></font></p>
					<!-- <p class="list-price text-danger">List Price<s>$2250</s></p> -->
					<!-- <p class="price"><font color="black" size="2" face="Playfair Display">Notre Prix : $1999</font></p> -->

					<button type="button" class="btn btn-sm btn-success" onclick="detailsmodal(<?=$croisiere5['idCroisiere'];?>,<?=$idUser;?>)">Details</button>
